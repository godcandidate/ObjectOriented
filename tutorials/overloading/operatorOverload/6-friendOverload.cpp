...
class points3D
{
    ...
    public:
        ...
        friend points3D operator +(points3D point1, points3D point2);

};

points3D operator +(points3D point1, points3D point2)
{
    points3D temp;
...
int main()
{
    ...
    cout << "\n\t Overload of + and - using friend function\n\n";
    ...
    string obj[4] = {"PointA", "PointB", "Point C(A-B)", "Point A+B+C"};
    for (int i = 0; i<4; i++)
    {
